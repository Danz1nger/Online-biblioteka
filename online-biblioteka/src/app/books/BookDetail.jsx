...
const BookDetail = () => {
  ...
  return (
    <div className="user-profile">
      ...
      <div className="review-icon-container" style={{ position: 'fixed', bottom: '20px', right: '20px' }}>
        <IconButton onClick={toggleReviewForm}>
          <MessageIcon style={{ color: 'green', fontSize: '40px' }} />
        </IconButton>
      </div>
